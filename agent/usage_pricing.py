...
def resolve_billing_route(
    ...
    if provider_name == "eden" or base_url_host_matches(base_url or "", "inference-api.projectglacie.com"):
        return BillingRoute(provider="eden", model=model, base_url=base_url or _NOUS_DEFAULT_BASE_URL, billing_mode="official_models_api")
