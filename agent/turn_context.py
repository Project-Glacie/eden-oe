...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``eden logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Eden OE only initiates compaction in "eden" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Eden OE preflight compression for codex app-server "
                "(mode=%s); Eden OE will not start thread compaction here.",
