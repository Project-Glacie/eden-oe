...
Usage:
    eden pairing list              # Show all pending + approved users
    eden pairing approve <platform> <code>  # Approve a pairing code
    eden pairing revoke <platform> <user_id> # Revoke user access
    eden pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle eden pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: eden pairing {list|approve|revoke|clear-pending}")
        print("Run 'eden pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.eden/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'eden pairing list' to see pending codes.\n")
