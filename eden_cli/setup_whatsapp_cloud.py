...
Entry point: ``eden whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``eden_cli/main.py``).
...
Eden gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print()
    print("❤️ WhatsApp Business Cloud API Setup")
    print("=" * 50)
    print()
    print("This wizard configures Eden OE to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Eden OE needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Eden OE gateway in another terminal:")
    print("         eden gateway")
    print()
    ...
    print()
    print("  Docs: https://eden-agent.projectglacie.com/docs/user-guide/")
