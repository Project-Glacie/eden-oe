"""
Skills configuration for Eden OE.
`eden skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.eden/config.yaml under:
...
from eden_cli.config import cfg_get, load_config, save_config
from eden_cli.colors import Colors, color
from eden_cli.platforms import PLATFORMS as _PLATFORMS
