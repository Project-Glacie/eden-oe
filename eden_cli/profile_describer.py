...
Used by ``eden profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Eden OE kanban board.
...
Rules:
  ...
  - Never write "Eden OE profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_eden_home())
        else:
