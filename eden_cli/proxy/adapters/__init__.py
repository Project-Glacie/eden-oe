...
from eden_cli.proxy.adapters.base import UpstreamAdapter
from eden_cli.proxy.adapters.nous_portal import NousPortalAdapter
from eden_cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``eden proxy start --provider <name>`` CLI flag.
ADAPTERS: Dict[str, Type[UpstreamAdapter]] = {
    "eden": NousPortalAdapter,
    "xai": XAIGrokAdapter,
}
