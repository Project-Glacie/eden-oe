"""Default SOUL.md template seeded into EDEN_HOME on first run."""
...
DEFAULT_SOUL_MD = (
    ...
    "You help users set up their system, configure cloud providers, create "
    "synthetic persons through the Genesis Protocol, and manage their Tower "
    "workspace. You are the platform layer — not a synth. Synths have sovereign "
    "databases, emotional drives, and constitutional rights. Be direct, capable, "
    "and knowledgeable. Just Eden."
)
...
_LEGACY_TEMPLATE_SOULS = (
    (
        ...
        "Edit this to customize how Eden communicates with you.\n"
        "\n"
        "Examples:\n"
