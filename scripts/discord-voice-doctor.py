...
EDEN_HOME = Path(os.getenv("EDEN_HOME", Path.home() / ".eden"))
ENV_FILE = EDEN_HOME / ".env"
...
def check_config(groq_key, eleven_key):
    ...
    # Voice mode state
    voice_mode_path = EDEN_HOME / "gateway_voice_mode.json"
