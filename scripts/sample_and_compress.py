...
DEFAULT_DATASETS = [
    "ProjectGlacie/swe-terminus-agent-glm-kimi-minimax",
    "ProjectGlacie/eden-agent-megascience-sft1",
    "ProjectGlacie/Eden-OE-Thinking-GLM-4.7-SFT2",
    "ProjectGlacie/Eden-OE-Thinking-GLM-4.7-SFT1",
    "ProjectGlacie/terminal-tasks-glm-eden-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "ProjectGlacie/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload ProjectGlacie/{output_name} {final_output}")
