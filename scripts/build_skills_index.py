#!/usr/bin/env python3
"""Build the Eden OE Skills Index — a centralized JSON catalog of all skills.
...
`eden skills search/install` can use it without hitting the GitHub API.
...
# Ensure EDEN_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Eden OE Skills Index...", flush=True)
