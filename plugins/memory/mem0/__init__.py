...
Configuration
-------------
Secret (lives in $EDEN_HOME/.env or the environment):
...
Behavioral settings (live in $EDEN_HOME/mem0.json, set via `eden memory
setup`):
  ...
  agent_id           — Agent identifier (default: eden)
...
def _load_config() -> dict:
    """Load config from env vars, with $EDEN_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "eden"),
        "oss": {},
    }
    ...
    config_path = get_eden_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, eden_home):
        """Write config to $EDEN_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $EDEN_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "eden")
