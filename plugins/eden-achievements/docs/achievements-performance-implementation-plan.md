# Eden OE Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.eden/plugins/eden-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.eden/plugins/eden-achievements/scan_checkpoint.json`.
