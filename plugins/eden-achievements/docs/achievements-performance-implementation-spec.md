# Eden OE Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.eden/plugins/eden-achievements/state.json` (existing unlock state)
  - `~/.eden/plugins/eden-achievements/scan_snapshot.json` (new)
  - `~/.eden/plugins/eden-achievements/scan_checkpoint.json` (new)
