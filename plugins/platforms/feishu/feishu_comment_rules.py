...
Config: ~/.eden/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.eden/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_eden_home()`` helper (EDEN_HOME-aware and
...
RULES_FILE = get_eden_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_eden_home() / "feishu_comment_pairing.json"
