...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Eden OE gateway adapter.

    Each inbound phone number gets its own Eden OE session (multi-tenant).
...
# static dict in eden_cli/gateway.py, and the _send_sms dispatch in
