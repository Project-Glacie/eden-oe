...
Only included in the eden-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Eden-OE (https://github.com/ProjectGlacie/eden-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_eden_home() / "cache" / "discord_capabilities.json"
