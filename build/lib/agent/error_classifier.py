...
#
# See: https://github.com/ProjectGlacie/eden-agent/issues/27344
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, Eden) run before
    ...
    if status_code == 404:
        # Eden API currently surfaces HA/NAS credit depletion as a paid model
