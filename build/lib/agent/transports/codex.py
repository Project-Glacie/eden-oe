...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Eden OE's web-provider config and
        ...
        # native search engine for xAI sessions instead of Eden OE's
        # configured web provider (Tavily/etc.), and those results bypass
        # Eden OE's tool-trace / citation plumbing (they arrive baked into the
