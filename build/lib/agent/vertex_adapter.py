"""Vertex AI (Google Cloud) adapter for Eden OE.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Eden OE to use Gemini models via Google Cloud with
...
# who installed plain `eden-agent` and only later selected a Gemini model.
try:
