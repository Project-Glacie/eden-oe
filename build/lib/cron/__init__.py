"""
Cron job scheduling system for Eden OE.
...
Cron jobs are executed automatically by the gateway daemon:
    eden gateway install    # Install as a user service
    sudo eden gateway install --system  # Linux servers: boot-time system service
    eden gateway            # Or run in foreground
