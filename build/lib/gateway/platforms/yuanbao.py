...
try:
    ...
    _EDEN_OE_VERSION = "0.0.0"

_APP_VERSION = _EDEN_OE_VERSION
_BOT_VERSION = _EDEN_OE_VERSION
_YUANBAO_INSTANCE_ID = str(EDEN_OE_INSTANCE_ID)  # single source: yuanbao_proto.EDEN_OE_INSTANCE_ID
