...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$EDEN_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_eden_dir("platforms/whatsapp/session", "whatsapp/session")
