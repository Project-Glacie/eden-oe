...
Trust levels:
  - builtin:   Ships with Eden OE. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.eden/\.env|\~/.eden/\.env',
     "eden_env_access", "critical", "exfiltration",
     "directly references Eden OE secrets file"),
    ...
    (r'\.eden/config\.yaml|\.eden/SOUL\.md',
     "eden_config_mod", "critical", "persistence",
     "references Eden OE configuration files directly"),
...
# scan. `.skillignore` is the Eden-native name; `.clawhubignore` is honored
