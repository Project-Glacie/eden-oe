...
Invoked by ``eden kanban decompose [task_id | --all]`` and the
...
* Mirrors the shape of ``eden_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Eden OE board.
...
def _profile_author() -> str:
    """Mirror of ``eden_cli.kanban._profile_author``."""
    return (
