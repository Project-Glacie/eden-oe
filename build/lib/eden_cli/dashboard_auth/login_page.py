...
Visual styling mirrors the Project Glacie design system (the
``@project-glacie/ui`` package the React dashboard uses): the same
...
``tests/eden_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Eden OE</title>
<style>
  /* Brand fonts shipped by @project-glacie/ui — same files the SPA loads. */
  @font-face {{
...
<body>
<main>
  <div class="brand">Eden<span class="dot"></span>OE</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Eden OE dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Eden OE</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
<p>Install <code>plugins/dashboard-auth-eden</code> (default) or another
