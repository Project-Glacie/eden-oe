...
def _has_eden_os_browser() -> bool:
    ...
    # install.sh installs globally into $EDEN_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-EdenHome", str(get_eden_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = eden_subprocess_env(inherit_credentials=False)
