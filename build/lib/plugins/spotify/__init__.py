...
``_check_spotify_available()`` — when the user has not run ``eden auth
spotify``, the tools remain registered (so they appear in ``eden
...
The Spotify auth flow (``eden auth spotify``), CLI plumbing, and docs
