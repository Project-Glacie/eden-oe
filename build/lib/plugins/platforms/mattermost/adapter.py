...
required — uses aiohttp which is already a Eden OE dependency.
...
def interactive_setup() -> None:
    ...
    ``eden_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Eden OE delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # eden_cli/setup.py::_setup_mattermost function.
