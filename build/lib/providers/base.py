...
def _profile_user_agent() -> str:
    """Return a ``eden-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from eden_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"eden-cli/{_ver}"
    except Exception:
        return "eden-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # eden-cli UA so the catalog endpoint is reachable.
